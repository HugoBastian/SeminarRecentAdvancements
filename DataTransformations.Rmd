...
# Handling Missing Data: Maximum Likelihood
...
```{r}
write.csv(subset_data_imputed, "/Users/hugovandenbelt/Documents/GitHub/Research Note EUR Recent Advancements/GSS_subset_imputed.csv", row.names = FALSE)
```
